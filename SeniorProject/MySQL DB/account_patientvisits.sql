...
CREATE TABLE `patientvisits` (
  ...
  CONSTRAINT `patientvisits_ibfk_1` FOREIGN KEY (`PatientID`) REFERENCES `patients` (`Patientid`),
  CONSTRAINT `patientvisits_ibfk_2` FOREIGN KEY (`AppointmentID`) REFERENCES `appointments` (`AppointmentId`)
...
INSERT INTO `patientvisits` VALUES (1,2,1,'2024-05-10','A check up visit for the progress in diet');
